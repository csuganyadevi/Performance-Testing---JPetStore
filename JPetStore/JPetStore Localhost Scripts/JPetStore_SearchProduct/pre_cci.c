# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c"
...
# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c" 2
...
# 2 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c" 2
...
# 3 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c" 2
...
vuser_init()
{
   ...
   lr_start_transaction("JPetStore_SearchProduct_T01_Launch");
	...
	web_url("Catalog.action", 
  	...
  	lr_end_transaction("JPetStore_SearchProduct_T01_Launch", 2);
	...
	lr_start_transaction("JPetStore_SearchProduct_T02_Login");
	...
	lr_end_transaction("JPetStore_SearchProduct_T02_Login", 2);
	
	}
	
	else
	{
		lr_end_transaction("JPetStore_SearchProduct_T02_Login", 1);
...
# 4 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c" 2
...
lr_start_transaction("JPetStore_SearchProduct_T03_Selectcategory");
	...
	web_url("sm_category.gif", 
		...
		lr_end_transaction("JPetStore_SearchProduct_T03_Selectcategory", 2);
	...
	lr_end_transaction("JPetStore_SearchProduct_T04_SelectProduct", 2);
	...
	{
		lr_end_transaction("JPetStore_SearchProduct_T05_ViewItem", 2);
	}
else 
{
	lr_end_transaction("JPetStore_SearchProduct_T05_ViewItem", 1);
...
# 5 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c" 2
...
vuser_end()
{
	...
	web_url("Account.action_3", 
		...
		lr_end_transaction("JPetStore_SearchProduct_T06_Signout", 2);

	
	return 0;
}
# 6 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_searchproduct\\\\combined_JPetStore_SearchProduct.c" 2
