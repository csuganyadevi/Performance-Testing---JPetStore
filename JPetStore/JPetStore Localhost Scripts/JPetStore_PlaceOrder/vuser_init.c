...
//	JSESSIONID=C62D41F690CFF3D1FD89A14DB16878F5;
   ...
   lr_start_transaction("JPetStore_PlaceOrder_T01_Launch");
	...
	web_url("Catalog.action", 
  	...
  	lr_end_transaction("JPetStore_PlaceOrder_T01_Launch", LR_AUTO);
	...
	lr_end_transaction("JPetStore_PlaceOrder_T02_Login", LR_AUTO);
	
	}
	
	else
	{
		lr_end_transaction("JPetStore_PlaceOrder_T02_Login", LR_FAIL);
