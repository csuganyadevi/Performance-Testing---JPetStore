# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c"
...
# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c" 2
...
# 2 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c" 2
...
char  *sCategory, *sProductID, *sItemID;


# 3 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c" 2
...
vuser_init()
{
   ...
   lr_start_transaction("JPetStore_PlaceOrder_T01_Launch");
	...
	web_url("Catalog.action", 
  	...
  	lr_end_transaction("JPetStore_PlaceOrder_T01_Launch", 2);
	...
	lr_start_transaction("JPetStore_PlaceOrder_T02_Login");
	...
	lr_end_transaction("JPetStore_PlaceOrder_T02_Login", 2);
	
	}
	
	else
	{
		lr_end_transaction("JPetStore_PlaceOrder_T02_Login", 1);
...
# 4 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c" 2
...
lr_start_transaction("JPetStore_PlaceOrder_T03_Selectcategory");
	...
	web_url("sm_category.gif", 
		...
		lr_end_transaction("JPetStore_PlaceOrder_T03_Selectcategory", 2);
	...
	lr_end_transaction("JPetStore_PlaceOrder_T04_SelectProduct", 2);
	...
	lr_end_transaction("JPetStore_PlaceOrder_T05_ViewItem", 2);
	...
	lr_end_transaction("JPetStore_PlaceOrder_T06_AddtoCart", 2);
	...
	lr_end_transaction("JPetStore_PlaceOrder_T07_checkout", 2);
	...
	lr_save_datetime("%m/%d", 0 + (86400 * 99), "ExpiryDate");
	...
	lr_end_transaction("JPetStore_PlaceOrder_T08_PaymentDetails", 2);
	...
	{
		lr_end_transaction("JPetStore_PlaceOrder_T09_PlaceOrder", 2);
	}
else 
{
	lr_end_transaction("JPetStore_PlaceOrder_T09_PlaceOrder", 1);
...
# 5 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c" 2
...
vuser_end()
{
		...
		lr_start_transaction("JPetStore_PlaceOrder_T10_Signout");
	...
	web_url("Account.action_3", 
		...
		lr_end_transaction("JPetStore_PlaceOrder_T10_Signout", 2);

	
	return 0;
}
# 6 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_placeorder\\\\combined_JPetStore_PlaceOrder.c" 2
