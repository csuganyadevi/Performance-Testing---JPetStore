# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c"
...
# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c" 2
...
# 2 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c" 2
...
char *UserName, *fName;
# 3 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c" 2
...
# 4 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c" 2

# 1 "User_Registration.c" 1
User_Registration()
{
	...
	lr_end_transaction("JPetStore_UserRegistration_T01_Launch", 2);
	...
	lr_end_transaction("JPetStore_UserRegistration_T02_SignIn", 2);
	...
	lr_end_transaction("JPetStore_UserRegistration_T03_RegisterNow", 2);
	...
	statuscode = web_get_int_property(1);
	
	if (statuscode == 500)
	{
	lr_end_transaction("JPetStore_UserRegistration_T04_SaveAccount",1);
	
	}
	else
	{
		
	lr_end_transaction("JPetStore_UserRegistration_T04_SaveAccount",2);
...
# 5 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c" 2
...
# 6 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_registerusers\\\\combined_JPetStore_RegisterUsers.c" 2
