# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c"
...
# 1 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c" 2
...
# 2 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c" 2
...
char  *sCategory, *sProductID;


# 3 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c" 2
...
vuser_init()
{
   ...
   lr_start_transaction("JPetStore_Browsecategories_T01_Launch");
	...
	lr_end_transaction("JPetStore_Browsecategories_T01_Launch", 2);
	
	}
	
	else
	{
		lr_end_transaction("JPetStore_Browsecategories_T01_Launch", 1);
...
# 4 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c" 2

# 1 "Browseategories.c" 1
Browseategories()
{
...
lr_start_transaction("JPetStore_Browsecategories_T02_Selectcategory");
	...
	web_url("Catalog.action;jsessionid={SessionID}", 
		...
		lr_end_transaction("JPetStore_Browsecategories_T02_Selectcategory", 2);
...
web_url("Catalog.action_2", 
	...
	{
		lr_end_transaction("JPetStore_Browsecategories_T03_SelectProduct", 2);
	}
else 
{
	lr_end_transaction("JPetStore_Browsecategories_T03_SelectProduct", 1);
...
# 5 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c" 2
...
# 6 "d:\\suganya\\lr sripts\\jpetstore new project\\jpetstore_browsecategories\\\\combined_JPetStore_Browsecategories.c" 2
